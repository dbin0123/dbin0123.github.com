...
date: 2021-03-06
description: "深入浅出 Java 多线程》第二篇 原理片-volatile关键字"
tags: java 《深入浅出Java多线程》 volatile
---   
#### volatile关键字
##### 回顾及介绍几个基本的概念
- 内存可见性
...
```java
/**
 * @ClassName : ThreadVloatile2
 * @Description : Volatile关键字内存可见性
 * @Author : dbin0123
 * @Date: 2021-03-06 23:12
 */
public class ThreadVloatile2 {
...
![image](http://dbin0123.github.io/images/posts/thread/203/volatile内存示意图.jpg)
...
![image](http://dbin0123.github.io/images/posts/thread/203/内存屏障.png)
